import{S as C,a as N,s as o,p as t,b as h,c as T,R as F,u as z,r as l,j as e,d as a,F as g}from"./index.be744900.js";import{S as j,L as k}from"./index.f7c9fabd.js";import{b as W}from"./bilibili.03841b80.js";import{g as G}from"./request.4600e0a8.js";import{C as O}from"./CSSTransition.370e09b8.js";const R=i=>({type:N,data:i}),f=i=>({type:C,data:i}),_=i=>n=>{G().then(d=>{let c=d.filter(u=>u.title.indexOf(i)!=-1);n(R(c)),n(f(!1))})},A=o.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
