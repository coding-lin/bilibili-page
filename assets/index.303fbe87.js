import{M as y,N as v,s,p as n,b as G,c as D,R as E,u as S,r as p,d,j as e,e as b}from"./index.f395b866.js";import{S as w,L as $}from"./index.d78c3927.js";import{b as C}from"./request.1a40f1a0.js";import{b as T}from"./actionCreators.61ba9552.js";import{W as N,G as k}from"./index.9cda9f09.js";import"./index.e6576498.js";import"./bilibili.03841b80.js";const O=t=>({type:v,data:t}),g=t=>({type:y,data:t}),W=t=>i=>{C().then(c=>{let a=c.filter(h=>h.title.indexOf(t)!=-1);i(O(a)),i(g(!1))})},j=s.div`
  width: 100%;
`,R=s.div`
  position: fixed;
  top: 0;
