import{M as x,N as y,s,p as n,b as v,c as E,R as G,u as D,r as p,d,j as e,e as S}from"./index.2aac3aef.js";import{S as w,L as $}from"./index.0dee0801.js";import{b}from"./request.be9e33f4.js";import{W as T,G as C}from"./index.001730f8.js";import"./index.9bec9b7f.js";import"./bilibili.03841b80.js";const N=t=>({type:y,data:t}),g=t=>({type:x,data:t}),k=t=>i=>{b().then(c=>{let a=c.filter(h=>h.title.indexOf(t)!=-1);i(N(a)),i(g(!1))})},O=s.div`
  width: 100%;
`,W=s.div`
  position: fixed;
  top: 0;
