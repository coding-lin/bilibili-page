...
`;function Ve(){const o=le.map(n=>i(K.Item,{children:i("div",{className:"content",style:{backgroundImage:`url(${n.img})`},onClick:()=>{q.show(`\u4F60\u70B9\u51FB\u4E86\u7535\u5F71 ${n.id}`)}})},n.id));return i(Se,{children:i("div",{className:"container",children:i(K,{autoplay:!0,loop:!0,children:o})})})}const Ee=D.div`
  width: 100%;
