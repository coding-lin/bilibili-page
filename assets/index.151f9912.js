import{M as v,N as y,s,p as n,b as G,c as D,R as E,u as S,r as p,d,j as e,e as b}from"./index.84d41d77.js";import{S as w,L as $}from"./index.67fff423.js";import{b as C}from"./request.4bb1a9ce.js";import{b as N}from"./actionCreators.819d9ea3.js";import{W as T,G as k}from"./index.8cdb9cdd.js";import"./index.f73340ce.js";import"./bilibili.03841b80.js";const O=t=>({type:y,data:t}),l=t=>({type:v,data:t}),W=t=>i=>{C().then(c=>{let a=c.filter(h=>h.title.indexOf(t)!=-1);i(O(a)),i(l(!1))})},j=s.div`
  width: 100%;
`,R=s.div`
  position: fixed;
  top: 0;
