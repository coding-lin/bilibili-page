...
`;function Xe(){const t=me.map(o=>r(X.Item,{children:r("div",{className:"content",style:{backgroundImage:`url(${o.img})`},onClick:()=>{ge.show(`\u4F60\u70B9\u51FB\u4E86\u7535\u5F71 ${o.id}`)}})},o.id));return r(Oe,{children:r("div",{className:"container",children:r(X,{autoplay:!0,loop:!0,children:t})})})}const We=W.div`
  width: 100%;
...
`;var Le="./assets/bilibili.01065c11.gif";const De=W.div`
  .video-box {
    margin: ${s(5)};
    border-radius: ${s(2)};
    .video-img {
