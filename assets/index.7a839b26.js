import{S as C,a as N,s as o,p as e,b as h,c as T,R as F,u as z,r as c,j as t,d as a,F as p}from"./index.358b1047.js";import{S as j,L as k}from"./index.19e6101f.js";import{g as W,b as G}from"./bilibili.b89de760.js";import{C as O}from"./CSSTransition.52189598.js";const R=i=>({type:N,data:i}),f=i=>({type:C,data:i}),_=i=>n=>{W().then(d=>{let l=d.filter(u=>u.title.indexOf(i)!=-1);n(R(l)),n(f(!1))})},A=o.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
