import{n as x,o as y,s as r,p as i,b as v,c as E,R as G,u as D,r as h,d as c,j as e}from"./index.e03f2702.js";import{S,L as w}from"./index.f7bdd269.js";import{c as $}from"./bilibili.063eb136.js";import{W as b,G as T}from"./index.397a3d17.js";import"./index.7883637e.js";const C=t=>({type:y,data:t}),g=t=>({type:x,data:t}),k=t=>n=>{$().then(d=>{let a=d.filter(p=>p.title.indexOf(t)!=-1);n(C(a)),n(g(!1))})},N=r.div`
  width: 100%;
`,O=r.div`
  position: fixed;
  top: 0;
