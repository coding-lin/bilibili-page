import{S as C,a as N,s as o,p as t,b as h,c as T,R as F,u as j,r as c,j as e,d as a,F as g}from"./index.144ea4a3.js";import{S as z,L as k}from"./index.78015b8b.js";import{g as W,b as G}from"./bilibili.5451eba9.js";import{C as O}from"./CSSTransition.e0010c6e.js";const R=i=>({type:N,data:i}),f=i=>({type:C,data:i}),_=i=>n=>{W().then(d=>{let l=d.filter(u=>u.title.indexOf(i)!=-1);n(R(l)),n(f(!1))})},A=o.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
