import{S as C,a as N,s as o,p as t,b as h,c as T,R as F,u as j,r as l,j as e,d as a,F as p,e as z}from"./index.9884a26e.js";import{S as k,L as W}from"./index.075917bc.js";import{b as G}from"./bilibili.03841b80.js";import{g as O}from"./request.8cf404ae.js";import{C as R}from"./CSSTransition.c047d10a.js";const _=i=>({type:N,data:i}),f=i=>({type:C,data:i}),A=i=>n=>{O().then(d=>{let c=d.filter(u=>u.title.indexOf(i)!=-1);n(_(c)),n(f(!1))})},B=o.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
