import{C as h,B as f,D as u,E as b,G as $,s as r,p as i,r as k,j as e,d as s,A as c,T as C}from"./index.d3e398d6.js";import{a as L,b as _}from"./request.aa10649e.js";import{_ as N}from"./index.19948997.js";import{b as G}from"./bilibili.03841b80.js";const v=n=>({type:h,data:n}),x=n=>({type:f,data:n}),y=n=>({type:u,data:n}),w=n=>({type:b,id:n}),D=n=>({type:$,id:n}),T=()=>n=>{L().then(a=>{n(v(a))})},j=()=>n=>{_().then(a=>{n(x(a)),n(y(!1))})},B=n=>a=>{a(w(n))},I=n=>a=>{a(D(n))},q=r.div`
  width: 100%;
  padding-bottom: ${i(20)};
