...
`;function He(){const t=pe.map(i=>n(q.Item,{children:n("div",{className:"content",style:{backgroundImage:`url(${i.img})`},onClick:()=>{Y.show(`\u4F60\u70B9\u51FB\u4E86\u7535\u5F71 ${i.id}`)}})},i.id));return n(Re,{children:n("div",{className:"container",children:n(q,{autoplay:!0,loop:!0,children:t})})})}const Te=B.div`
  width: 100%;
