import{C as h,B as f,D as u,E as $,G as b,s as r,p as i,r as k,j as e,d as o,L,A as c,T as C}from"./index.6104a6e4.js";import{a as _,b as N}from"./request.8a845f46.js";import{_ as G}from"./index.7f1d5081.js";import{b as v}from"./bilibili.03841b80.js";const x=n=>({type:h,data:n}),y=n=>({type:f,data:n}),w=n=>({type:u,data:n}),D=n=>({type:$,id:n}),O=n=>({type:b,id:n}),j=()=>n=>{_().then(a=>{n(x(a))})},B=()=>n=>{N().then(a=>{n(y(a)),n(w(!1))})},I=n=>a=>{a(D(n))},q=n=>a=>{a(O(n))},H=r.div`
  width: 100%;
  padding-bottom: ${i(20)};
