import{M as y,N as D,s as r,p as n,b as G,c as E,R as S,u as b,r as l,d,j as i,e as w}from"./index.6104a6e4.js";import{S as C,L as $}from"./index.2e9532ce.js";import{b as N}from"./request.8a845f46.js";import{b as T,d as k,W as O,G as W}from"./index.fb9ea054.js";import"./index.7f1d5081.js";import"./bilibili.03841b80.js";const j=t=>({type:D,data:t}),p=t=>({type:y,data:t}),R=t=>e=>{N().then(c=>{let a=c.filter(h=>h.title.indexOf(t)!=-1);e(j(a)),e(p(!1))})},_=r.div`
  width: 100%;
`,I=r.div`
  position: fixed;
  top: 0;
